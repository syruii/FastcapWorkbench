class FastCapWorkBench(Workbench):
    ...
    def Initialize(self):
        ...
        import exportMesh # import here all the needed files that create your FreeCAD commands
        self.list = ["exportMesh_Cmd"]  # A list of command names created in the line above
