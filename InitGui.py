...
class FastCapWorkBench(Workbench):
    ...
    def Initialize(self):
        ...
        import exportMesh, importMesh # import here all the needed files that create your FreeCAD commands
        self.list = ["exportMesh_Cmd", "importMesh_Cmd"]  # A list of command names created in the line above
